...
class Notification(AbstractNotification):
    VERB_CODES = Choices("favorites_add", "task_add", "task_completed", "comment_add", "acquainted")
    ...
    def add_custom_fields(cls, send_result:  list | list[tuple[Any | None, Any]],
                          verb_code: str, previous_title: str = None, previous_body: str = None) -> None:
        """
        ...
        :param previous_body: previous body of edited task
        """
